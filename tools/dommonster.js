(function() {
    ...
    setTimeout(function() {
		...
		node.style.cssText += "-webkit-transition:-webkit-transform ease-out 0.3s; -webkit-transform:translateY(-450px); transition:transform ease-out 0.3s; transform:translateY(-450px);";
		
		setTimeout(function(){
			node.style.cssText += '-webkit-transform:translateY(30px); transform:translateY(30px);';
		}, 10);
		//*/
    }, 10);
})();
