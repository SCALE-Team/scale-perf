...
function perfmap(performanceApi, toolContainer) {
	...
	for ( var i=0, len = elements.length; i < len; i++ ) {
		elements[i].onmouseover = function(){
			...
			timeline.style.cssText = "opacity:1; transition: 0.5s ease-in-out; -webkit-transform: translate("+ parseInt(timelineLeft) + "px,0); transform: translate("+ parseInt(timelineLeft) + "px,0); position:absolute; z-index:4; border-left:2px solid white; height:100%;";
		}
		elements[i].onmouseout = function(){		
			...
			timeline.style.cssText = "opacity:0; transition: 0.5s ease-in-out; -webkit-transform: translate("+ parseInt(timelineLeft) + "px,0) transform: translate("+ parseInt(timelineLeft) + "px,0); position:absolute; z-index:4; border-left:2px solid white; height:100%;";
		}
	}
}